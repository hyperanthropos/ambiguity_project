...
elseif logrec(7,reward_trial) == 2; % ambiguous trial
    disp([ 'an ambiguous amount of either ' num2str( logrec(14,reward_trial) ) 'CHF or ' num2str(logrec(14,reward_trial)) 'CHF' ]);
end
disp(' ');
if logrec(5,reward_trial) == 1 || 3; % fixed amount
    disp([ 'you decided for the ' num2str(logrec(16,reward_trial)) 'CHF for sure.']);
    disp('so this is what you will get');
...
elseif logrec(5,reward_trial) == 4; % ambiguous amount
    disp('you decided for:');
    disp([ 'an ambiguous amount of either ' num2str( logrec(14,reward_trial)*100 ) 'CHF or ' num2str() 'CHF' ]);
