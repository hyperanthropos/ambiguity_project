function [ matlabbatch ] = create_first_level( )
% function to create first level batch
%   creates basic batch to be modified for each subject

matlabbatch{1}.spm.stats.fmri_spec.dir = '<UNDEFINED>';
matlabbatch{1}.spm.stats.fmri_spec.timing.units = 'secs';
matlabbatch{1}.spm.stats.fmri_spec.timing.RT = 2.37;
...
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).name = 'risk';
...
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).orth = '<UNDEFINED>';
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).name = 'ambiguity';
...
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).orth = '<UNDEFINED>';
