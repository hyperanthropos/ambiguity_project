...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'risk pos';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [1 0];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'risk neg';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = [-1 0];
matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'ambi pos';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.weights = [0 1];
matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'ambi neg';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.weights = [0 -1];
matlabbatch{3}.spm.stats.con.consess{4}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{5}.tcon.name = 'risk > ambi';
matlabbatch{3}.spm.stats.con.consess{5}.tcon.weights = [1 -1];
matlabbatch{3}.spm.stats.con.consess{5}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{6}.tcon.name = 'ambi > risk';
matlabbatch{3}.spm.stats.con.consess{6}.tcon.weights = [-1 1];
matlabbatch{3}.spm.stats.con.consess{6}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{7}.fcon.name = 'effects of interest';
matlabbatch{3}.spm.stats.con.consess{7}.fcon.weights = [1 0; 0 1];
